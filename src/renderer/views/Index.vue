    ...
    <el-aside width="380px">
      <div>
        <el-input placeholder="请输入内容" v-model="input3" class="input-with-select">
          ...
          <el-button slot="append" icon="el-icon-plus" class="add"></el-button>
        </el-input>
      </div>
      ...
      <el-main>
        <el-row>
          <el-col :span="18" class="remote-col">
            ...
            <div class="msg-content">“颜色代码:红色#FF0000 深紫色 #871F78 褐红色 #8E236B 石英色 #D9D9F3 绿色#00FF00 深石板蓝 #6B238E 中海蓝色 #32CD99 艳蓝色 #5959AB 蓝色#0000FF 深铅灰色 #2F4F4F 中蓝色 #3232CD 鲑鱼色 #6F4242 牡丹红 #FF00FF 深棕褐色 #97694F 中森林绿 #6B8E23 猩红色 #BC1717 青色#00FFFF 深绿松石色 #7093DB</div>
          </el-col>
